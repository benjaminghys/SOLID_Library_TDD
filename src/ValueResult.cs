namespace LibraryExercise
{
    ...
    public class Result<T> : IResult<T>
    {
        ...
        public static Result<T?> FailResult(string errorMessage) => new Result<T?>(false, default, errorMessage);
        ...
        public override string ToString() => this.Success ? $"Success: {this.Value}" : $"Failure: {this.ErrorMessage}";
    }
}